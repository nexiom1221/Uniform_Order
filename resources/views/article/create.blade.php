...
<div class="px-64">
		...
		<form action="/article" method="POST">
			...
			<input class="border border-gray-800 w-full @error('content') border border-red-700 @enderror" type="text" name="title" id="title" value="{{ old('title') ? old('title') : '' }}" required><br>

			name
			<input class="border border-gray-800 w-full @error('email') border border-red-700 @enderror" name="email" id="email" cols="10" rows="10" required value="{{ Auth::user()->name }}"><br>
			<br>
